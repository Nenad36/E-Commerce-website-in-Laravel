                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item">
                                    <div
                                        class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img
                                                src="{{ asset('frontend/images/best_4.pn') }}g" alt=""></div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Headphones</a></div>
                                            <div class="bestsellers_name"><a href="product.html">Xiaomi Redmi Note 4</a>
                                            </div>
                                ...
                                <div class="review d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    <div class="review_content">
                                        ...
                                        <div class="review_text"><p>Lorem ipsum dolor sit amet, consectetur
                                          adipiscing elit. Maecenas fermentum laoreet.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="newsletter_content clearfix">
                            <form action="{{ route('store.newsletter') }}" method="POST" class="newsletter_form">
                                ...
                                <input type="email" name="email"
                                       class="newsletter_input @error('email') is-invalid @enderror" required="required"
